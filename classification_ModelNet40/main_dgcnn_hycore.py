...
def parse_args():
    ...
    parser.add_argument('--model', default='HypeDGCNN', help='model name [default: pointnet_cls]')
    parser.add_argument('--num_classes', default=40, type=int, help='default value for classes of ScanObjectNN')
...
def main():
    ...
    net = DGCNN(args,output_channels=args.num_classes)		#Hype_pointMLP(num_classes=args.num_classes)	#models.__dict__[args.model](num_classes=args.num_classes)
