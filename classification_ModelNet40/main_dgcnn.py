...
def main():
    ...
    # Model
    printf(f"args: {args}")
    printf('\n==> Building model DGCNN for ScanObj classification\n')
    net = DGCNN(args,output_channels=args.num_classes)			#models.__dict__[args.model](num_classes=args.num_classes)
    criterion = cal_loss
    net = net.to(device)
